...
**Depends on:** nothing. **Blocks:** every comparative claim.
...
- Per-configuration area and power deltas, including those that saved nothing (R-3.12, R-4.18)
...
**Depends on:** D-9, and fabrication.
...
**Previous:** [`07-implementation-constraints.md`](07-implementation-constraints.md) ·
**Next:** [`09-acceptance-criteria.md`](09-acceptance-criteria.md)
