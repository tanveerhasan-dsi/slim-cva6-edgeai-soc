...
> [!IMPORTANT]
> Gates are defined by **artifact and evidence**, never by elapsed time. A gate
> is passed when its evidence exists and is reproducible.

## The ten gates

| Gate | Passed when | Deliverable |
|:--:|---|:--:|
| [**1**](#gate-1--method-established) | Method established | D-1 |
| [**2**](#gate-2--baseline-characterised) | Baseline characterised | D-2 |
| [**3**](#gate-3--subset-report-reproducible) | Subset report reproducible | D-3 |
| [**4**](#gate-4--configurations-build-and-measure) | Configurations build and measure | D-4 |
| [**5**](#gate-5--equivalence-proven) | Equivalence proven | D-6 |
| [**6**](#gate-6--compatibility-demonstrated) | Compatibility demonstrated | D-5 |
| [**7**](#gate-7--reinvestment-measured) | Reinvestment measured | D-7 |
| [**8**](#gate-8--prototype-closes-the-loop) | Prototype closes the loop | D-8 |
| [**9**](#gate-9--signoff) | Signoff | D-9 |
| [**10**](#gate-10--silicon-measured) | Silicon measured | D-10 |
