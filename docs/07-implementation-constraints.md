...
failure mode is an NDA breach that cannot be undone by a later commit. Directory
boundaries and a CI check are cheap; a leak is not.
...
silently — which is worse than having none, because they are trusted. Generate
it.

---

**Previous:** [`06-verification-requirements.md`](06-verification-requirements.md) ·
**Next:** [`08-deliverables.md`](08-deliverables.md)
