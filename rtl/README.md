...
> [!WARNING]
> Record the upstream CVA6 commit in the manifest. Start from **current**
> upstream — the repository was restructured, and a checkout predating the
> `core/` layout and `config_pkg` will not match any current documentation.
